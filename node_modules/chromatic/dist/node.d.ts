...
declare const configurationSchema: ZodObject<{
    ...
    diagnostics: ZodOptional<ZodUnion<[ZodString, ZodBoolean]>>;
...
interface Options {
    ...
    experimental_onTaskError?: (ctx: Context, { formattedError, originalError }: {
...
declare function runAll(ctx: any): Promise<void>;
...
export { Configuration, Context, Flags, GitInfo, Options, TaskName, getConfiguration, getGitInfo, run, runAll };
